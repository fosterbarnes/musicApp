...
#define AppDisplayName "musicApp (x64)"
#ifndef AppVersion
...
#define DotNetPrereqUrl "https://builds.dotnet.microsoft.com/dotnet/WindowsDesktop/10.0.10/windowsdesktop-runtime-10.0.10-win-x64.exe"
#define DotNetPrereqFile "windowsdesktop-runtime-10.0.10-win-x64.exe"
