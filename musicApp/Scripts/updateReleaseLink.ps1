...
$tagName = "v$version"
$zipFileName = "musicApp_v${version}_${versionTag}.zip"
...
$oldLinkRegex = '\[download the latest release\]\(https://github\.com/' + $ownerRepoEscaped + '/releases/download/v[^)]+\.zip\)'
...
Write-Host "Updated README release link -> $releaseUrl"
